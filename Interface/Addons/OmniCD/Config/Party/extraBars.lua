	...
	progressBar = {
		...
		args = {
			...
			showInterruptedSpell = {
				hidden = isRaidCDBar,
				disabled = isDisabledOrNameBar,
				name = "|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t" .. L["Interrupted Spell Icon"],
			...
			showRaidTargetMark = {
				...
				disabled = isDisabledOrNameBar,
				name = "|TInterface\\OptionsFrame\\UI-OptionsFrame-NewFeatureIcon:0:0:0:-1|t" .. L["Interrupted Target Marker"] .. E.RAID_TARGET_MARKERS[1],
