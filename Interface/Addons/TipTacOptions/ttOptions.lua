...
local options = {
	-- General
	{
		...
		{ type = "DropDown", var = "nameType", label = "Name Type", list = { 
		["NAME only (no pvp titles)"] = "normal", 
		["Copy from original tip"] = "original", 
		["Mary Sue Protocol (rpname)"] = "marysueprot", 
		["PvP: title NAME"] = "title", 
		["PvP: title NAME (#rank)"] = "pvptitlerank", 
		["PvP: NAME (#rank)"] = "pvpnum",
		["PvP: NAME (#rank) title"] = "pvprank"
		}, y = 16 },
	...
	-- Special
	{
		...
		{ type = "Check", var = "showTTguildAfter", label = "Show Guildname after Level/race/class line", tip = "Shows <Guild> after level line, otherwise shows right after the Name" }, -- DaMaGepy
 	},
	-- Colors
	{
		[0] = "Colors",
