...
private.CONTINENT_ZONE_IDS = {
	...
	[9997] = { zonefilter = true, npcfilter = true, zones = {100001,100002,100003,100004,100005,100006,100007,100008,100009,100010,100011,100012,100013,100014,100015} }; --Dungeons or scenarios
}
